...
<html lang="es">
  ...
  <body>
		<div class="container">
			...
			<form method="post" action="../Logic/create-request.php" >
				...
				<div class="row">					
					<div class="col-lg-6">	
						<form action="mainAlumno.php">
							<input type="button" class="btn btn-secondary btn-block" onclick="location.href='mainAlumno.php';" value="Cancelar" />
						</form>
					</div>
					<div class="col-lg-6">	
